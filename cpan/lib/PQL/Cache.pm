...
# === IO =============================================================================
# --- Create Instance from Dump -----------------
sub new_from_dump {
    my $package_load = shift || croak "can't reload from dump without package name given";
    my $file_name    = shift || croak "can't reload from dump without file name given";
    ...
    $self = eval($package_load.'::load_cache();');
